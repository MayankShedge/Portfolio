...
const Footer = () => {
    return (
        <footer className="py-6 text-center border-t border-lightest-navy">
            <p className="font-mono text-sm text-slate mb-4">
                Designed & Built by Mayank Shedge
            </p>
             <div className="md:hidden flex justify-center space-x-6">
                    <a href="https://github.com/MayankShedge" target="_blank" rel="noopener noreferrer" className="text-slate hover:text-green transition-colors">
                        <IconGitHub />
                    </a>
                    <a href="https://www.linkedin.com/in/mayank-shedge-899381230" target="_blank" rel="noopener noreferrer" className="text-slate hover:text-green transition-colors">
                        <IconLinkedin />
                    </a>
             </div>
        </footer>
